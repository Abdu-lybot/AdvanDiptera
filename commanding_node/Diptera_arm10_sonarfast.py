...
class Arming_Modechng():
    ...
    def print_battery_status(self):
        stringtorospy = ("Current voltage: " + str(self.battery_voltage))
        rospy.logwarn(stringtorospy)
        stringtorospy = ("Current current: " + str(self.battery_current))
        rospy.logwarn(stringtorospy)
        stringtorospy = ("Remaining: " + str(self.battery_voltage_remaining))
        rospy.logwarn(stringtorospy)
    ...
    def calculate_thrust(self):
        ...
        elif self.down_sensor_distance <= self.hover_sensor_altitude_min - 0.3 and thrust <= self.Liftoff_thrust_maximum: # We have to go up + change thrusts variables
...
if __name__ == '__main__':
    ...
    try:
        ...
        if arm.down_sensor_distance != None:
            ...
            rospy.logerr("No sonar detected, disarming")
